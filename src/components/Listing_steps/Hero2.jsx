    ...
    <>
      <div className="max-w-6xl  mx-auto py-4">
        ...
        <ScrollArea h={500} type="never">
          <div className="max-w-6xl grid w-full h-full  border rounded-lg border-[#9B9B9B] lg:p-2 p-4 my-4">
            ...
            <div className="flex  flex-wrap gap-8 lg:my-2 my-8">
              <img
                className="rounded-lg lg:w-[350px] lg:h-[226px] md:w-[300px]  md:h-[226px] sm:w-[280px] sm:h-[226px] mb-6  object-cover object-center "
                src={item3}
                alt=""
              />
              <FileUpload />
        ...
        <div className="max-w-6xl flex justify-between items-center md:my-6 my-14 mx-8 md:mx-0">
          <Link to="/addLocation">
