  ...
  return (
    <div>
      <div className='w-[90%] md:w-[95%] lg:w-[70%] mx-auto border-gray-200 shadow-2xl rounded-xl flex md:flex-row flex-col p-4 lg:flex-col md:mx-auto  gap-x-3'>
            <div>
            <div className='h-[200px] w-full rounded-md bg-[url("https://d2blna3sxzw742.cloudfront.net/Property-Photos/46-Thumbnail_1.jpg")] bg-center bg-cover'>
            </div>
            ...
            <div className='h-[200px]  w-full md:w-[75%] lg:w-full bg-slate-200 rounded-3xl mt-2'>
            ...
            <div className="">
            <div className='md:w-[200px] lg:w-full w-full md:h-[100px] lg:h-[50px] h-[50px] bg-slate-200 mt-3 rounded-full flex md:flex-col lg:flex-row'>
            ...
            <div className='w-full md:h-[100px] lg:h-[50px] h-[50px] bg-slate-200 mt-3 rounded-full flex md:flex-col lg:flex-row '>
