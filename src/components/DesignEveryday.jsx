...
import rect475 from "../icons/Rectangle 475.png";
import rect484 from "../icons/Rectangle 484.png";
import rect4444 from "../icons/kevin-mccutcheon-APDMfLHZiRA-unsplash 1 (1).png";
      ...
      <div className="message h-screen w-screen bg-zinc-200 mt-[0vh] grid grid-cols-6 grid-rows-5 gap-0">
        ...
        <div className="border border-zinc-200 md:border-zinc-400  bg-zinc-200  col-span-2 ">
          <div className="leading-none mb-3 text-center pb-3 pt-2 md:flex md:flex-col md:pt-4">
            <h1 className="md:text-2xl text-lg text-zinc-800 font-semibold ">
              Design your every
            </h1>
            <h1 className="md:text-2xl text-lg text-zinc-800 font-semibold ">
              day food plate
        ...
        {/* Row 2, Column 2 */}
        <div
          className="border border-zinc-400 bg-zinc-200  col-span-2 "
        ...
        >
          <div className=" px-2 py-3 min-w-[40%]  md:max-w-[70%] text-sm  font-semibold flex justify-center items-center rounded-full bg-orange-600 text-white">
            Explore more
