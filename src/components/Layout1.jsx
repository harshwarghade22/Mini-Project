    ...
    <div className="Layout-1 bg-zinc-500 h-screen w-full grid grid-cols-1 grid-rows-4 gap-[2px] mx-auto p-[1px] ">
      ...
      <div className="bg-zinc-500 grid md:grid-cols-6 md:row-span-2 gap-[2px] ">
        ...
        <div className="bg-zinc-50 md:col-span-4 flex justify-start items-center pt-[6vw] px-3 flex-col gap-[2px] p-2">
          ...
          <div
            className={`bg-zinc-200 p-5 mx-auto flex rounded-3xl h-[70%] w-[65%] ease-in-out duration-5 ${
              where ? "" : "hidden"
            }`}
          >
            <ul className="font-semibold tracking-wide">
              <li className="hover:scale-105 hover:w-full hover:bg-zinc-300 px-5 py-1 rounded-xl">
                Bangalore
              </li>
              <li className="hover:scale-105 hover:w-full hover:bg-zinc-300 px-5 py-1 rounded-xl">
                Gurugram
          ...
          <div
            className={`bg-zinc-200 p-5 mx-auto flex rounded-3xl h-[70%] w-[65%] justify-center ease-in-out duration-5 ${
              size ? "" : "hidden"
            }`}
          >
            <ul className="font-semibold tracking-wide">
          ...
          <div
            className={`bg-zinc-200 p-5 mx-auto flex rounded-3xl h-[70%] w-[65%] justify-end text-left ease-in-out duration-5 ${
              Mates ? "" : "hidden"
            }`}
          >
            <ul className="font-semibold tracking-wide">
              <li className="hover:scale-105 hover:w-full hover:bg-zinc-300 px-2 py-1 rounded-xl">
                single
              </li>
              <li className="hover:scale-105 hover:w-full hover:bg-zinc-300 px-2 py-1 rounded-xl">
                Double
